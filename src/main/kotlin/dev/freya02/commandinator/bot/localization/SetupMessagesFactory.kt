...
@BService
class ClassFileBasedSetupMessagesFactory(
    private val context: BContext,
    private val guildLocaleProvider: GuildLocaleProvider,
    private val userLocaleProvider: UserLocaleProvider,
) : SetupMessagesFactory {
    ...
    private val clazz = run {
        ...
        val newClassDesc = ClassDesc.of(ClassFileBasedSetupMessagesFactory::class.java.packageName, "SetupMessagesImplGenerated")
        val newClassBytes = classFile.build(newClassDesc) { classBuilder ->
            classBuilder.withFlags(ClassFile.ACC_FINAL)
            classBuilder.withInterfaceSymbols(classDesc<SetupMessages>())
            ...
            SetupMessages::class.declaredFunctions.forEach {
    ...
    override fun create(event: Interaction): SetupMessages {
        ...
        return constructor.invoke(localizationContext) as SetupMessages
    }
